...
use Firevel\ApiResourceGenerator\Factories\ResourceIndexFeatureTestFileFactory;
...
class ResourceIndexFeatureTestFileFactoryTest extends TestCase
{
    use WithFaker;
    ...
    public function it_creates_the_tests_directory_if_it_does_not_exist(): void
    {
        ...
        ResourceIndexFeatureTestFileFactory::handle($resource);
    }
    ...
    public function it_calls_stub_builder_with_the_correct_params(): void
    {
        ...
        StubBuilder::shouldReceive('build')
            ->with('feature-tests/index', $resource->toArray())
            ->once();
    ...
    public function it_calls_file_maker_with_the_correct_params(): void
    {
        ...
        FileMaker::shouldReceive('make')
            ->with(base_path("tests/Feature/{$resource->pluralPascal()}/Index{$resource->pluralPascal()}Test.php"), $content)
            ->once();
