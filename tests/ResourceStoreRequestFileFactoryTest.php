...
use Firevel\ApiResourceGenerator\Factories\ResourceStoreRequestFileFactory;
...
class ResourceStoreRequestFileFactoryTest extends TestCase
{
    use WithFaker;
    ...
    public function it_creates_the_requests_directory_if_it_does_not_exist(): void
    {
        ...
        ResourceStoreRequestFileFactory::handle($resource);
    }
    ...
    public function it_calls_stub_builder_with_the_correct_params(): void
    {
        ...
        StubBuilder::shouldReceive('build')
            ->with('requests/store', $resource->toArray())
            ->once();
    ...
    public function it_calls_file_maker_with_the_correct_params(): void
    {
        ...
        FileMaker::shouldReceive('make')
            ->with(app_path("Http/Requests/{$resource->singularPascal()}/Store{$resource->singularPascal()}.php"), $content)
            ->once();
