...
use Firevel\ApiResourceGenerator\Factories\ResourceShowFeatureTestFileFactory;
...
class ResourceShowFeatureTestFileFactoryTest extends TestCase
{
    use WithFaker;
    ...
    public function it_creates_the_tests_directory_if_it_does_not_exist(): void
    {
        ...
        ResourceShowFeatureTestFileFactory::handle($resource);
    }
    ...
    public function it_calls_stub_builder_with_the_correct_params(): void
    {
        ...
        StubBuilder::shouldReceive('build')
            ->with('feature-tests/show', $resource->toArray())
            ->once();
    ...
    public function it_calls_file_maker_with_the_correct_params(): void
    {
        ...
        FileMaker::shouldReceive('make')
            ->with(base_path("tests/Feature/{$resource->pluralPascal()}/Show{$resource->pluralPascal()}Test.php"), $content)
            ->once();
